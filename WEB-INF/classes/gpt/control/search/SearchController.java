...
throws AbortProcessingException, Exception {
	System.out.println("SearchController:processSubAction");
  try {
    ...
    if( e instanceof SearchException) {
    	System.out.println("SearchController:searchException");
...
throws AbortProcessingException, Exception {
	System.out.println("SearchController:processSearchActions");
