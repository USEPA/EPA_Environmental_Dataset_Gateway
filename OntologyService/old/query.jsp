<%@ page language="java" contentType="text/plain; charset=UTF-8" pageEncoding="UTF-8"%><%@page import="java.io.IOException, java.util.logging.FileHandler, java.util.Iterator, java.util.Set, java.util.HashMap,java.sql.ResultSet,java.sql.PreparedStatement, java.sql.SQLException, java.sql.DriverManager, java.sql.Connection, java.util.Enumeration, java.text.SimpleDateFormat, java.util.Date, java.text.DateFormat, java.util.logging.Logger"%><%!
    ...
    if (term != null) {
        ...
        while (rs.next()) {
            ...
            if (weight >= _weight && weight>0) {
                returnStr += getQuoteEnclosedTerm(rs.getString("target").toString()) + "^" + weight + " ";
            }
        }
        out.print(returnStr);
    }
