    ...
    <body onload="update()">
        ...
        <table class="form">
            ...
            <tr>
                <td>BT weight:</td>
                <td>
                    <input id="BT" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>RT weight:</td>
                <td>
                    <input id="RT" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>NT weight:</td>
                <td>
                    <input id="NT" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>UF weight:</td>
                <td>
                    <input id="UF" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>AF weight:</td>
                <td>
                    <input id="AF" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>AB weight:</td>
                <td>
                    <input id="AB" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>SY weight:</td>
                <td>
                    <input id="SY" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>FNTT weight:</td>
                <td>
                    <input id="FNTT" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>ATT weight:</td>
                <td>
                    <input id="ATT" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>USE weight:</td>
                <td>
                    <input id="USE" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>CF weight:</td>
                <td>
                    <input id="CF" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td>CB weight:</td>
                <td>
                    <input id="CB" onkeyup="update();"/>
                </td>
            </tr>
            <tr>
                <td></td>
