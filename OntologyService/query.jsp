...
%><%
    ...
    weights.put("CF", "0.95");
    weights.put("CB", "0.95");
	weights.put("PVO", "0.95");
	weights.put("PVF", "0.95");
    ...
    if (term != null) {
		...
		try {
			...
			while (rs.next()) {
				...
				String rsstring = rs.getString("path").toString();
				//log.info("rsstring: " + rsstring);
			...
			//out.println("error occurs at sql.executeQuery");
			log.info("error occurs at sql.executeQuery: " + e);
        }		
