...
public SearchFilterKeyword() {
  ...
  regions.add("Region 01");
  regions.add("Region 02");
  regions.add("Region 03");
  regions.add("Region 04");
  regions.add("Region 05");
  regions.add("Region 06");
  regions.add("Region 07");
  regions.add("Region 08");
  regions.add("Region 09");
  regions.add("Region 10");
    
  //fill the check map with the items defaulted to unchecked
  for (String region : regions) {
      checkMap.put(region,Boolean.FALSE);
  }
}
