...
<%
    ...
    try {
        ...
        FileHandler handler = new FileHandler("D:\\Public\\Server\\Tomcat\\logs\\metrics.log");
    ...
    batchUpdateAll update = new batchUpdateAll("https://edg.epa.gov/metadata/ESRIRestServlet", logger, obj.getConnection());
    update.doUpdate();
