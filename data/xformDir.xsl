				    ...
				    <table width="950px" border="0" align="center" cellpadding="0" cellspacing="0">
					    <tr>
						    ...
						    <td align="left">
                                                        ...
                                                        <font size='2' color='#9999ab' face='Verdana'>The EPA Environmental Dataset Gateway (EDG) provides a data download location for EPA Regions, Program Offices, and Research Laboratories that want to make data available online for download but do not have their own server available.  
                                                            Users can access the publicly accessible data by clicking on the folders below. EPA employees and affiliates may use the Login link at the top of this page to view additional, restricted content, or browse to an <a href="http://edg-intranet.epa.gov/data/" target="_blank">equivalent page </a><img src="/DataUtils/images/EnterIntranet.png"/> on the EPA Intranet for better download performance.</font>
                                                        <br/>
                                                        <br/>
                                                        <font size='2' color='#9999ab' face='Verdana'>EPA employees who would like to publish data on this site should review the <a href="https://edg.epa.gov/metadata/webhelp/en/gptlv10/inno/EDG_Download_Locations.pdf" target="_blank">publishing procedures</a>.</font>
                                                        <br/>  														
                                                        <br/>
							</td>
					    </tr>
...
<!-- End Google Tag Manager -->
    ...
    <xsl:template match="fileSize">
            <xsl:choose>
                <xsl:when test="substring(.,string-length(.))='B'">
                    <xsl:value-of select="." />
                </xsl:when>                
